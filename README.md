...
魔法師西蒙的價值,九成在對白——尤其是對**托爾金**的致敬與吐槽,是全劇最好笑的部分。這一版把整場戲都翻了,舉幾段當年最經典的:
...
從閣樓的舊皮箱裡翻出《古老魔法書》開始,西蒙的冒險就此展開。以下是**實際遊玩**的畫面:

| | |
|---|---|
| ![閣樓](docs/img/gameplay_attic.png) | ![臥室](docs/img/gameplay_bedroom.png) |
| 閣樓——故事的起點,西蒙在此發現魔法書 | 西蒙的臥室(海報、魚缸、亂糟糟的地板) |

遊戲進行中,西蒙的自言自語與旁白也全程中文:

![遊戲中中文字幕](docs/img/gameplay_bedroom_cht.png)

*(場景中的中文旁白——「我看還是把狗找出來、再塞進烘乾機一次好了。」)*

---

## 影片旁白

給這款遊戲配一支短片的話,大概會這樣講(約 80 秒):

**【0:00–0:10 開場】**
1993 年的《魔法師西蒙》是款讓你笑到肚子疼的英式冒險遊戲。三十年後,我們終於用繁體中文把它完整還原了——而且是原版從未有過的方式。
